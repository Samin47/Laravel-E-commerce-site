        ...
        <table>
            <tr style="background-color:grey">
                ...
                <tr style = "background-color:black; align-items-center;">
                    <td style = "padding:20px;color:white;">{{ $carts->product_title }}</td>
                    <td style = "padding:20px;color:white;">{{ $carts->quantity }}</td>
                    <td style = "padding:20px;color:white;">{{ $carts->price }}</td>
                    <td style = "padding:20px;color:white;"><a class="btn btn-danger" href="{{ url('deletecart',$carts->id )}}">Delete</a></td>
                </tr>
